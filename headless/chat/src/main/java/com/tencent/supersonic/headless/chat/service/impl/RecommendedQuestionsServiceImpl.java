...
public class RecommendedQuestionsServiceImpl
        extends ServiceImpl<RecommendedQuestionsMapper, RecommendedQuestions>
    ...
    public String findQuerySqlByQuestion(Integer agentId, String question) {
        ...
        wrapper.eq(RecommendedQuestions::getAgentId, agentId).eq(RecommendedQuestions::getQuestion,
                question);
